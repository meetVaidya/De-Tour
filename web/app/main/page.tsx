  ...
  const { user } = useAuthStore();
    ...
    const awardPoints = async () => {
      ...
      try {
        ...
        toast.success(`✨ Your journey grows stronger! +${pointsToAdd} points!`);
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[120px]">
          ...
          >
            <div>
              ...
              <p className="text-forest-600">
                Continue your journey through the magical realm...
              </p>
            </div>
            <div className="flex items-end justify-between">
              ...
              <span className="text-forest-500 text-sm">Level {stats.level}</span>
            </div>
          </motion.div>
          ...
          >
            <div className="flex justify-between items-center">
              <div>
                <h3 className="text-lg font-bold text-forest-800">Quick Stats</h3>
                <p className="text-forest-600 text-sm">Your journey so far</p>
              </div>
          ...
          >
            <p className="text-forest-700 italic">
              "Every grand adventure begins with a single step. Your journey awaits!"
            </p>
          </motion.div>
        </div>
      </div>
