          ...
          <div className="space-y-4 text-forest-600">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                <p className="font-medium text-forest-700">Owner</p>
                <p>{merchant.owner_name}</p>
              </div>
              <div className="space-y-1">
                <p className="font-medium text-forest-700">Business Type</p>
                <p>{merchant.business_type}</p>
              </div>
              <div className="space-y-1">
                <p className="font-medium text-forest-700">Email</p>
                <p>{merchant.email}</p>
              </div>
              <div className="space-y-1">
                <p className="font-medium text-forest-700">Phone</p>
                <p>{merchant.phone}</p>
              </div>
            </div>

            <div className="space-y-1 pt-4">
              <p className="font-medium text-forest-700">Address</p>
              <p>{merchant.address}</p>
            </div>

            <div className="space-y-1 pt-4">
              <p className="font-medium text-forest-700">Status</p>
