        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {merchants.map((merchant, index) => (
            <motion.div
              ...
              className="backdrop-blur-sm bg-white/90 rounded-xl shadow-lg p-8 border border-forest-200 hover:shadow-xl transition-all duration-300"
            >
              <h2 className="text-xl font-semibold text-forest-800 mb-4">{merchant.business_name}</h2>
              ...
              <Link
                ...
                className="inline-flex items-center space-x-3 px-6 py-3 bg-gradient-to-r from-forest-600 to-forest-500 hover:from-forest-700 hover:to-forest-600 text-white rounded-lg transition-all duration-200 group"
              >
