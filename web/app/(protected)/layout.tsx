...
export default function ProtectedLayout({
  ...
  useEffect(() => {
    ...
    if (user && !user.role) {
      ...
      if (pathname !== '/sign-up' && pathname !== '/onboarding') {
        console.log("ProtectedLayout: User authenticated but no role, redirecting to /sign-up to choose type.");
  ...
  if (user && !user.role && pathname !== '/sign-up' && pathname !== '/onboarding') {
